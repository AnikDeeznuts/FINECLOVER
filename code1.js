...
gdjs.GameSceneCode.GDFloatingOutButtonDarkBlueObjects5= [];
...
gdjs.GameSceneCode.GDNewVideoObjects1= [];
gdjs.GameSceneCode.GDNewVideoObjects2= [];
gdjs.GameSceneCode.GDNewVideoObjects3= [];
gdjs.GameSceneCode.GDNewVideoObjects4= [];
gdjs.GameSceneCode.GDNewVideoObjects5= [];
...
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDPlayerObjectObjects2Objects, (( gdjs.GameSceneCode.GDSpawnPointObjects2.length === 0 ) ? 0 :gdjs.GameSceneCode.GDSpawnPointObjects2[0].getPointX("")), (( gdjs.GameSceneCode.GDSpawnPointObjects2.length === 0 ) ? 0 :gdjs.GameSceneCode.GDSpawnPointObjects2[0].getPointY("")), "");
    ...
    gdjs.GameSceneCode.GDPlayerObjectObjects2[i].getBehavior("MultiplayerObject").enableBehaviorSynchronization("Physics2", false);
}
}}
...
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDPlayerNameObjects1Objects, (( gdjs.GameSceneCode.GDSpawnPointObjects1.length === 0 ) ? 0 :gdjs.GameSceneCode.GDSpawnPointObjects1[0].getPointX("")), (( gdjs.GameSceneCode.GDSpawnPointObjects1.length === 0 ) ? 0 :gdjs.GameSceneCode.GDSpawnPointObjects1[0].getPointY("")), "");
...
for (var i = 0, k = 0, l = gdjs.GameSceneCode.GDPlayerObjectObjects3.length;i<l;++i) {
    if ( gdjs.GameSceneCode.GDPlayerObjectObjects3[i].behaviorActivated("Physics2") ) {
...
{for(var i = 0, len = gdjs.GameSceneCode.GDPlayerObjectObjects3.length ;i < len;++i) {
    gdjs.GameSceneCode.GDPlayerObjectObjects3[i].activateBehavior("Physics2", false);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("FloatingOutButtonDarkBlue"), gdjs.GameSceneCode.GDFloatingOutButtonDarkBlueObjects2);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameSceneCode.GDFloatingOutButtonDarkBlueObjects2.length;i<l;++i) {
    if ( gdjs.GameSceneCode.GDFloatingOutButtonDarkBlueObjects2[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.GameSceneCode.GDFloatingOutButtonDarkBlueObjects2[k] = gdjs.GameSceneCode.GDFloatingOutButtonDarkBlueObjects2[i];
        ++k;
    }
}
gdjs.GameSceneCode.GDFloatingOutButtonDarkBlueObjects2.length = k;
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13374276);
}
}
}
}
...
for (var i = 0, k = 0, l = gdjs.GameSceneCode.GDMobileButtonObjects3.length;i<l;++i) {
    if ( gdjs.GameSceneCode.GDMobileButtonObjects3[i].getBehavior("ButtonFSM").IsPressed((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
...
for (var i = 0, k = 0, l = gdjs.GameSceneCode.GDMobileButtonObjects2.length;i<l;++i) {
    if ( !(gdjs.GameSceneCode.GDMobileButtonObjects2[i].getBehavior("ButtonFSM").IsPressed((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined))) ) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.pickAllObjects((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDIndicatorArrowObjects1Objects);
}
if (isConditionTrue_0) {
...
{for(var i = 0, len = gdjs.GameSceneCode.GDSawObjects3.length ;i < len;++i) {
    gdjs.GameSceneCode.GDSawObjects3[i].getBehavior("ShakeObject_PositionAngleScale").ShakeObject_PositionAngleScale(0.1, 0, 0, 0, -(50), 0.2, false, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}{for(var i = 0, len = gdjs.GameSceneCode.GDPlayerObjectObjects3.length ;i < len;++i) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.getSceneInstancesCount((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDPickUpObjects2Objects) > 0;
if (isConditionTrue_0) {
...
{gdjs.evtTools.sound.playSound(runtimeScene, "PickUp", false, 75, 1);
    ...
    gdjs.GameSceneCode.GDPickUpUIObjects3[i].getBehavior("ShakeObject_PositionAngle").ShakeObject_PositionAngle(0.5, 20, 20, 20, 0.1, false, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}}
...
{gdjs.evtTools.sound.playSound(runtimeScene, "New sound effect", false, 100, 1);
    ...
    gdjs.GameSceneCode.GDPickUpUIObjects2[i].getBehavior("ShakeObject_PositionAngle").ShakeObject_PositionAngle(2, 40, 40, 40, 0.1, false, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}}
...
{for(var i = 0, len = gdjs.GameSceneCode.GDScoreObjects3.length ;i < len;++i) {
    gdjs.GameSceneCode.GDScoreObjects3[i].getBehavior("Text").setText(gdjs.evtTools.common.toString(10 - gdjs.evtTools.object.getSceneInstancesCount((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.GameSceneCode.mapOfEmptyGDPickUpObjects)) + "/10");
}
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13398308);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13399196);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.GameSceneCode.GDPlayerObjectObjects2 */
...
gdjs.GameSceneCode.GDFloatingOutButtonDarkBlueObjects5.length = 0;
...
gdjs.GameSceneCode.GDNewVideoObjects1.length = 0;
gdjs.GameSceneCode.GDNewVideoObjects2.length = 0;
gdjs.GameSceneCode.GDNewVideoObjects3.length = 0;
gdjs.GameSceneCode.GDNewVideoObjects4.length = 0;
gdjs.GameSceneCode.GDNewVideoObjects5.length = 0;
